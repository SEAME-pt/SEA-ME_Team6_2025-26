...
// Tipo simples para armazenar os dados magnéticos convertidos
// Os testes verificam valores
...
// Handle I2C fornecido pelo mock dos testes O stub declara-a aqui para
