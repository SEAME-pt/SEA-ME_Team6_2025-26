/**
  * Versão testável do speedometer
  * Inclui o código original sem as dependências do STM32
  */

#include <stdio.h>
#include <stdint.h>
#include "main.h"      // Nossa versão mock
#include "tx_api.h"    // Nossa versão mock

// Definições do speedometer
#define PI 3.14159265
#define WHEEL_DIAMETER 0.06675f  // Em metros (66.75mm)
#define ENCODER_HOLES 18         // Furos no disco do encoder

// External mutex for printf protection (mock)
