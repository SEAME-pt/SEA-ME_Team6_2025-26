...
- `docs/TSF/tsf_implementation/.trudag_items/EVIDENCES/EVID_L0_14/EVIDENCES-EVID_L0_14.md`
	...
	??? "Click to view reference"
		...
		text: The repository contains TSF documentation structure with requirements, evidences, assertions, assumptions, and expectations.
		level: '1.14'
		normative: true
		references:
		- type: file
...
### ASSERTIONS-ASSERT_L0_16 | Reviewed: ✔ | Score: 0.0 ### {: #assertions-assert_l0_16 data-toc-label="ASSERTIONS-ASSERT_L0_16" .item-element .item-section class="tsf-score" style="background-color:hsl(0.0, 100%, 65%)"}
...
| Item {style="width:25%"} | Summary {style="width:50%"} | Score {style="width:0%"} | Status {style="width:25%"} |
| --- | --- | --- | --- |
| [EXPECTATIONS-EXPECT_L0_16](EXPECTATIONS.md#expectations-expect_l0_16) {class="tsf-score" style="background-color:hsl(60.0, 100%, 47%)"} |  | 0.50 | ✔ Item Reviewed<br>✔ Link Reviewed |

**Supporting Items:**

| Item {style="width:25%"} | Summary {style="width:50%"} | Score {style="width:0%"} | Status {style="width:25%"} |
| --- | --- | --- | --- |
| [EVIDENCES-EVID_L0_16](EVIDENCES.md#evidences-evid_l0_16) {class="tsf-score" style="background-color:hsl(0.0, 100%, 65%)"} | This evidence item collects repository artifacts, sprint reports and demo images that demonstrate the requirement is met. | 0.00 | ✔ Item Reviewed<br>✔ Link Reviewed |
...
### ASSERTIONS-ASSERT_L0_18 | Reviewed: ✔ | Score: 0.0 ### {: #assertions-assert_l0_18 data-toc-label="ASSERTIONS-ASSERT_L0_18" .item-element .item-section class="tsf-score" style="background-color:hsl(0.0, 100%, 65%)"}
...
| Item {style="width:25%"} | Summary {style="width:50%"} | Score {style="width:0%"} | Status {style="width:25%"} |
| --- | --- | --- | --- |
| [EXPECTATIONS-EXPECT_L0_18](EXPECTATIONS.md#expectations-expect_l0_18) {class="tsf-score" style="background-color:hsl(60.0, 100%, 47%)"} |  | 0.50 | ✔ Item Reviewed<br>✔ Link Reviewed |

**Supporting Items:**

| Item {style="width:25%"} | Summary {style="width:50%"} | Score {style="width:0%"} | Status {style="width:25%"} |
| --- | --- | --- | --- |
| [EVIDENCES-EVID_L0_18](EVIDENCES.md#evidences-evid_l0_18) {class="tsf-score" style="background-color:hsl(0.0, 100%, 65%)"} | This evidence item collects repository artifacts, sprint reports and demo images that demonstrate the requirement is met. | 0.00 | ✔ Item Reviewed<br>✔ Link Reviewed |
...
### ASSERTIONS-ASSERT_L0_21 | Reviewed: ✔ | Score: 0.0 ### {: #assertions-assert_l0_21 data-toc-label="ASSERTIONS-ASSERT_L0_21" .item-element .item-section class="tsf-score" style="background-color:hsl(0.0, 100%, 65%)"}
...
| Item {style="width:25%"} | Summary {style="width:50%"} | Score {style="width:0%"} | Status {style="width:25%"} |
| --- | --- | --- | --- |
| [EXPECTATIONS-EXPECT_L0_21](EXPECTATIONS.md#expectations-expect_l0_21) {class="tsf-score" style="background-color:hsl(60.0, 100%, 47%)"} |  | 0.50 | ✔ Item Reviewed<br>✔ Link Reviewed |

**Supporting Items:**

| Item {style="width:25%"} | Summary {style="width:50%"} | Score {style="width:0%"} | Status {style="width:25%"} |
| --- | --- | --- | --- |
| [EVIDENCES-EVID_L0_21](EVIDENCES.md#evidences-evid_l0_21) {class="tsf-score" style="background-color:hsl(0.0, 100%, 65%)"} | This evidence item collects repository artifacts, sprint reports and demo images that demonstrate the requirement is met. | 0.00 | ✔ Item Reviewed<br>✔ Link Reviewed |
...
### ASSERTIONS-ASSERT_L0_22 | Reviewed: ✔ | Score: 0.0 ### {: #assertions-assert_l0_22 data-toc-label="ASSERTIONS-ASSERT_L0_22" .item-element .item-section class="tsf-score" style="background-color:hsl(0.0, 100%, 65%)"}
...
| Item {style="width:25%"} | Summary {style="width:50%"} | Score {style="width:0%"} | Status {style="width:25%"} |
| --- | --- | --- | --- |
| [EXPECTATIONS-EXPECT_L0_22](EXPECTATIONS.md#expectations-expect_l0_22) {class="tsf-score" style="background-color:hsl(60.0, 100%, 47%)"} |  | 0.50 | ✔ Item Reviewed<br>✔ Link Reviewed |

**Supporting Items:**

| Item {style="width:25%"} | Summary {style="width:50%"} | Score {style="width:0%"} | Status {style="width:25%"} |
| --- | --- | --- | --- |
| [EVIDENCES-EVID_L0_22](EVIDENCES.md#evidences-evid_l0_22) {class="tsf-score" style="background-color:hsl(0.0, 100%, 65%)"} | This evidence item collects repository artifacts, sprint reports and timing measurements that demonstrate the STM32 ThreadX startup requirement is met. | 0.00 | ✔ Item Reviewed<br>✔ Link Reviewed |
