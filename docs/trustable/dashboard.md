...
??? example "click to view figure as table"
    ...
    |0.9-1.0 {style="background-color:hsl(120.0, 100%, 30%)"} |63|
...
??? example "click to view figure as table"
    ...
    |0.7-0.8 {style="background-color:hsl(96.0, 100%, 37%)"} |0|
    |0.8-0.9 {style="background-color:hsl(108.0, 100%, 33%)"} |0|
    |0.9-1.0 {style="background-color:hsl(120.0, 100%, 30%)"} |31|
...
??? example "click to view figure as table"
    ...
    |0.7-0.8 {style="background-color:hsl(96.0, 100%, 37%)"} |0|
    |0.8-0.9 {style="background-color:hsl(108.0, 100%, 33%)"} |0|
    |0.9-1.0 {style="background-color:hsl(120.0, 100%, 30%)"} |125|
## Summary
...
|----------|-------|
|statements|128|
|reviewed statements|128|
|unreviewed statements|0|
|orphaned statements|0|
|statements with evidence|64|
|evidence|64|
|expectations|32|
