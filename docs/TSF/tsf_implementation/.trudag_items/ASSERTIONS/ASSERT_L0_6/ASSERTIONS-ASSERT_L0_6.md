---
id: ASSERT-L0-6
header: Upon application launch, the display shows visible static content (e
text: 'Upon application launch, the display shows visible static content (e.g., rectangle,
  label, icon)
...
- type: file
  path: ../../items/evidences/EVID-L0-6.md
score: 0.5
reviewers:
