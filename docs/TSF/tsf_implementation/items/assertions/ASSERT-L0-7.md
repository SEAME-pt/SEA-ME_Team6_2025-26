---
id: ASSERT-L0-7
header: "Assertion: We should be able to crosscompile our QT program outside the Operating System..."
text: |
  We should be able to crosscompile our QT program outside the Operating System and the included the exec file running on it
