---
id: ASSERT-L0-8
header: "Assertion: A communication signal should be sent by the Rasp 5 and received in the STM32"
text: |
  A communication signal should be sent by the Rasp 5 and received in the STM32
  This should be observed from Rasp 5 to STM and from STM to Rasp5 (bidirectional communication)
