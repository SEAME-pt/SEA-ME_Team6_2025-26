---
id: ASSERT-L0-6
header: "Assertion: Upon application launch, the display shows visible static content (e"
text: |
  Upon application launch, the display shows visible static content (e.g., rectangle, label, icon)
