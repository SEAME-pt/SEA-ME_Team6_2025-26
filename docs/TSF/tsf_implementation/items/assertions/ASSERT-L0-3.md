---
id: ASSERT-L0-3
header: "Assertion: The PiRacer boots without system errors, and Qt development tools are..."
text: |
  The PiRacer boots without system errors, and Qt development tools are accessible from the command line
