---
id: EVID-L0-9
header: "Evidence: Software test including Visual inspection of the message bidirectional transmission. - ThreadX should be used on the Microcontroller (STM32) as a RTOS, receiving..."
text: |
