...
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/docs/demos/can_frames_protocol_structs
    - sprint6.jpeg
  description: 'Evidence from docs/demos/can_frames_protocol_structs - sprint6.jpeg:
    can frames protocol structs   sprint6'
- type: url
...
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/docs/guides/CAN-explanation.md
  description: 'Evidence from docs/guides/CAN-explanation.md: CAN explanation'
- type: url
  ...
  description: 'Evidence from docs/guides/ThreadX_Installation_Guide.md: ThreadX Installation
    Guide'
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/docs/guides/CAN-overview.md
  description: 'Evidence from docs/guides/CAN-overview.md: CAN overview'
- type: url
...
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/docs/images/CANFrame.png
  description: 'Evidence from docs/images/CANFrame.png: CANFrame'
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/docs/images/CANsignal.png
  description: 'Evidence from docs/images/CANsignal.png: CANsignal'
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/docs/images/CANtopology2.png
  description: 'Evidence from docs/images/CANtopology2.png: CANtopology2'
- type: url
...
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/docs/images/CANtopology.png
  description: 'Evidence from docs/images/CANtopology.png: CANtopology'
- type: url
...
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/src/ota/scripts/canary-check.sh
  description: 'Evidence from src/ota/scripts/canary-check.sh: canary check'
- type: url
  ...
  description: 'Evidence from src/kuksa/kuksa_RPi5/src/is_stm_connected.cpp: is stm
    connected'
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/src/kuksa/kuksa_RPi5/src/can_to_kuksa_publisher.cpp
  description: 'Evidence from src/kuksa/kuksa_RPi5/src/can_to_kuksa_publisher.cpp:
    can to kuksa publisher'
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/src/kuksa/kuksa_RPi5/src/can_decode.cpp
  description: 'Evidence from src/kuksa/kuksa_RPi5/src/can_decode.cpp: can decode'
- type: url
  ...
  description: 'Evidence from src/kuksa/kuksa_RPi5/src/handlers/heartbeat_stm.cpp:
    heartbeat stm'
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/src/kuksa/kuksa_RPi5/inc/can_decode.hpp
  description: 'Evidence from src/kuksa/kuksa_RPi5/inc/can_decode.hpp: can decode'
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/src/kuksa/kuksa_RPi5/inc/can_encode.hpp
  description: 'Evidence from src/kuksa/kuksa_RPi5/inc/can_encode.hpp: can encode'
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/src/kuksa/kuksa_RPi5/inc/can_to_kuksa_publisher.hpp
  description: 'Evidence from src/kuksa/kuksa_RPi5/inc/can_to_kuksa_publisher.hpp:
    can to kuksa publisher'
- type: url
  ...
  description: 'Evidence from src/kuksa/kuksa_RPi5/inc/is_stm_connected.hpp: is stm
    connected'
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/src/kuksa/kuksa_RPi5/inc/can_id.h
  description: 'Evidence from src/kuksa/kuksa_RPi5/inc/can_id.h: can id'
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/src/kuksa/kuksa_RPi4_display/inc/can_id.h
  description: 'Evidence from src/kuksa/kuksa_RPi4_display/inc/can_id.h: can id'
- type: url
...
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/src/tests/unit/cpp/can_decode.hpp
  description: 'Evidence from src/tests/unit/cpp/can_decode.hpp: can decode'
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/src/tests/unit/cpp/can_frame_builder.hpp
  description: 'Evidence from src/tests/unit/cpp/can_frame_builder.hpp: can frame
    builder'
- type: url
...
- type: url
  ...
  description: 'Evidence from src/tests/unit/cpp/heartbeat_stm_test.cpp: heartbeat
    stm test'
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/src/shared/backend/kuksa/can_id.h
  description: 'Evidence from src/shared/backend/kuksa/can_id.h: can id'
- type: url
...
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/src/stm/Core/Inc/can_tx.h
  description: 'Evidence from src/stm/Core/Inc/can_tx.h: can tx'
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/src/stm/Core/Inc/can_id.h
  description: 'Evidence from src/stm/Core/Inc/can_id.h: can id'
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/src/stm/Core/Inc/tasks/task_can_rx.h
  description: 'Evidence from src/stm/Core/Inc/tasks/task_can_rx.h: task can rx'
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/src/stm/Core/Src/can_tx.c
  description: 'Evidence from src/stm/Core/Src/can_tx.c: can tx'
- type: url
...
- type: url
  ...
  description: 'Evidence from src/stm/Core/Src/stm32u5xx_hal_msp.c: stm32u5xx hal
    msp'
- type: url
  url: https://github.com/SEAME-pt/SEA-ME_Team6_2025-26/blob/main/src/stm/Core/Src/tasks/task_can_rx.c
  description: 'Evidence from src/stm/Core/Src/tasks/task_can_rx.c: task can rx'
- type: url
