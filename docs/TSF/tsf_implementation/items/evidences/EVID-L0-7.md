---
id: EVID-L0-7
header: "Evidence: QT program crosscompliation validated with final exec file obtained, and execution of the exec file in the Rasp5 OS. - QT Crosscompilation should be achieved"
text: |
